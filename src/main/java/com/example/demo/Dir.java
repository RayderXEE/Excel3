...
/**
 * Created by Artem on 13.02.2020.
 */
public class Dir {
    ...
    public void run() throws Exception {
        Workbook workbookTemplate = new XSSFWorkbook(new FileInputStream(dirPath + "Template.xlsx"));
        Sheet sheetTemplate = workbookTemplate.getSheetAt(0);

        Workbook workbookOrder = new XSSFWorkbook(new FileInputStream(dirPath + "Order.xlsx"));
        Sheet sheetOrder = workbookOrder.getSheetAt(0);

        Workbook workbookPo = new XSSFWorkbook(new FileInputStream(dirPath + "Po.xlsx"));
        Sheet sheetPo = workbookPo.getSheet("Annex");

        Workbook workbookInterface = new XSSFWorkbook(new FileInputStream(dirPath + "Interface.xlsx"));
...
//        rowTotal.createCell(52).setCellFormula("SUM(BA33:BA"+(32+rs.size())+")");
        ...
        workbookTemplate.write(new FileOutputStream(dirPath + "Template Output.xlsx"));
    }
